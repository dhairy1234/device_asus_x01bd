...
TARGET_BOOTLOADER_BOARD_NAME := X01BD
...
TARGET_KERNEL_CONFIG := sdm600_defconfig

TARGET_FS_CONFIG_GEN := device/ASUS/X01BD/config.fs

#Bootloader
TARGET_BOARD_PLATFORM := sdm660
TARGET_BOARD_INFO_FILE := device/ASUS/X01BD/board-info.txt
...
#TARGET_BOARD_COMMON_PATH := device/ASUS/X01BD/660

#IPA
USE_DEVICE_SPECIFIC_DATAIPA_CFG_MGR := true
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/ASUS/X01BD/bluetooth
